  ...
  return (
    <div className="flex items-end gap-2 border-t border-indigo-100 bg-white px-3 py-3">
      <textarea
        ...
        aria-label="Message Anuj's AI twin"
        disabled={disabled}
        onKeyDown={handleKeyDown}
        onInput={handleInput}
        className="flex-1 resize-none rounded-xl border border-indigo-200 bg-indigo-50 px-3 py-2 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-400 disabled:opacity-50 leading-relaxed"
